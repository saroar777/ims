      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <?php }else{?>
              <span class="info-box-text"><strong>Nothing</strong></span>
              <?php }?>
            </div>
            <!-- /.info-box-content -->
          </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Todays Sell</span>
              <span class="info-box-number"><small>BDT. <?php echo number_format($total,0); ?></small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
      ...
      <div class="col-md-offset-1 col-md-10">
        <div class="box box-success">
          <div class="box-header with-border">
              <h3 class="box-title">List of Performed Products</h3>
          </div>
          <div class="box-body">
            <div class="col-md-offset-1 col-md-10">
              <div style="overflow-x:auto;">
                  <table class="table table-striped" id="myBestProduct">
                      ...
                      <tbody>
                          <?php
                          $no = 1;
                          $select = $pdo->prepare("SELECT product_code,
                                                          product_name,
                                                          price,
                                                          ...
                                                          FROM
                          tbl_invoice_detail GROUP BY product_id ORDER BY sum(qty) DESC");
                          $select->execute();
                          ...
                          ?>
                              ...
                              <td>BDT <?php echo number_format($row->price);?></td>
