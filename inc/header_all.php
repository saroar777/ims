    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li><a href="./Unit.php"><i class="fa fa-balance-scale"></i> <span>Product Unit</span></a></li>
          <li><a href="./register.php"><i class="fa fa-users"></i> <span>Application User</span></a></li>
