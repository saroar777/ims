        ...
        if(isset($_POST['product_code'])){
            ...
            if($select->rowCount() > 0 ){
                echo'<script type="text/javascript">
                    ...
                    swal("Warning", "Product Code Already Listed", "warning", {
                    button: "Continue",
                        });
                    });
                    </script>';
                    ...
                    echo'<script type="text/javascript">
                    jQuery(function validation(){
                    swal("Warning", "Code Must Be 6 Characters According to the Rules", "warning", {
                    button: "Continue",
                        });
                    });
                    </script>';
            ...
            if($img_ext == 'jpg' || $img_ext == 'jpeg' || $img_ext == 'png' || $img_ext == 'gif'){
                if($img_size>= 10000000){
                    $error ='<script type="text/javascript">
                            jQuery(function validation(){
                            swal("Error", "File Should Be 10MB", "error", {
                            button: "Continue",
                                });
                            });
                            </script>';
                ...
                <div class="box-body">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <span class="text-muted">*Make Sure Product Code</span>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <span class="text-muted">*Product Suitable Unit</span>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="Unit" required>
                                ...
                                while($row = $select->fetch(PDO::FETCH_ASSOC)){
                                    extract($row)
                                ?>
                                    <option><?php echo $row['nm_Unit']; ?></option>
                                <?php
                                }
                                ?>
                            </select>
