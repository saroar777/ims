                    ...
                    <table class="table table-striped" id="myProduct">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <td>BDT <?php echo number_format($row->purchase_price);?></td>
                                <td>BDT <?php echo number_format($row->sell_price); ?></td>
								<td>BDT <?php echo number_format($row->sell_price-$row->purchase_price); ?></td>
