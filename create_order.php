        ...
        <div class="box box-success">
          <form action="" method="POST">
            ...
            <div class="box-body">
              <div class="col-md-offset-1 col-md-10">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="input-group-addon">
                      <span>BDT <?php echo $_SESSION['invoice_id']; ?></span>
                    </div>
            ...
            <div class="box-footer" align="center">
              <input type="submit" name="save_order" value="Make Transaction" class="btn btn-success">
  ...
  //Date picker
    ...
    $(document).ready(function(){
      $(document).on('click','.btn_addOrder', function(){
        ...
        html+='<td><input type="number" min="1" max="10000000" class="form-control quantity_product" style="width:100px;" name="quantity[]" required></td>';
